/* Tyga Financials — desktop visual polish. Execution controls are rendered inside Trades. */
(() => {
  'use strict';
  ...
  #tygaExecutionPanel,#tygaDesktopBadge{display:none!important}
  `;document.head.appendChild(style);
  document.getElementById('tygaExecutionPanel')?.remove();document.getElementById('tygaDesktopBadge')?.remove();
})();
